const KINDS = [
  ...
  { name: 'masterdatamanager', pathFull: 'enterprise.masterdatamanager', path: 'masterdata', },
  { name: 'masterdata', pathFull: 'enterprise.masterdatamanager.masterdata' },
];

export default ENTERPRISE_CONTRACT = {
  metadata: {
    kind: { type: 'string', value: 'enterprise', readonly: true },
    path: { type: 'string', value: 'enterprise', readonly: true },
